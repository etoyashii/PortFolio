...
import BannerC from './Banner_Cyberbonk.png';
...
export default function GameplayPortfolio() {
    ...
    const profile = {
        firstName: "Emeric",
        lastName: "DEPREZ",
        description: "aaaaÉtudiant passionné par le développement gameplay, je crée des expériences de jeu immersives et innovantes. Spécialisé dans la mécanique de jeu, l'IA, les systèmes de gameplay et l'UI/UX, je recherche un stage pour continuer à apprendre et contribuer à des projets ambitieux."
    };
    ...
    const projects = [
        {
            id: 1,
            title: "ENARIA - MMORPG",
            description: "Un MMORPG mélangeant le gameplay de Dofus et le lore de SAO, sur ce projet je me suis principalement occupé des mini jeux des mini jeux de récolte (faits uniquement en ui), ça a été ma première expérience sur Unity, j'ai vraiment adoré.",
        ...
        },
        {
            ...
            description: "Un FPS en solo dans un hôpital infesté de zombies, j'ai pu m'occuper des ennemies et de la map.",
            duration: "Temps de prod : 1 semaine",
            image: LogoHS,
        ...
        },
        {
            ...
            description: "Un roguelite 3D en vue topdown dans lequel j'ai pu apprendre a me servir de l'input system d'Unity, a gérer des animations et a des ennemies plus complexes que sur le projet Hospital Survivor.",
            duration: "Temps de prod : 1 semaine",
            image: BannerL,
            tags: ["Unity", "C#", "Combat System", "Animation", "VFX"],
        ...
        },
        {
            ...
            link: "https://youtu.be/7rpkog1lZ6g"
        }
    ];
